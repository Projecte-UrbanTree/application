    ...
    public function run(): void
    {
        DB::table('work_reports')->insert([
            [
                ...
                'work_order_id' => 1,
                'report_status' => 1,
                'report_incidents' => 'Incident for Work Report 1',
            ],
            [
                ...
                'work_order_id' => 2,
                'report_status' => 2,
                'report_incidents' => 'Incident for Work Report 2',
            ],
            [
                ...
                'work_order_id' => 3,
                'report_status' => 3,
                'report_incidents' => 'Incident for Work Report 3',
            ],
            [
                ...
                'work_order_id' => 4,
                'report_status' => 1,
                'report_incidents' => 'Incident for Work Report 4',
            ],
            [
                ...
                'work_order_id' => 5,
                'report_status' => 2,
                'report_incidents' => 'Incident for Work Report 5',
            ],
            [
                ...
                'work_order_id' => 6,
                'report_status' => 1,
                'report_incidents' => 'Incident for Work Report 6',
            ],
            [
                ...
                'work_order_id' => 7,
                'report_status' => 3,
                'report_incidents' => 'Incident for Work Report 7',
            ],
            [
                ...
                'work_order_id' => 8,
                'report_status' => 2,
                'report_incidents' => 'Incident for Work Report 8',
            ],
            [
                ...
                'work_order_id' => 9,
                'report_status' => 1,
                'report_incidents' => 'Incident for Work Report 9',
            ],
            [
                ...
                'work_order_id' => 10,
                'report_status' => 2,
                'report_incidents' => 'Incident for Work Report 10',
            ],
        ]);
    }
}
