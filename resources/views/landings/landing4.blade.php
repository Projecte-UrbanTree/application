...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    <meta charset="UTF-8" />
    <title>Landing 4 - {{ config('app.name') }}</title>
  ...
  <body class="antialiased text-gray-900 bg-white" x-data="{ openPayment: false, plan: '', method: '', showOverlay: false }">
    ...
    <section class="relative w-full h-screen flex flex-col items-center justify-center text-center">
      <img src="{{ asset('images/landings/landing4/bg_herosection.jpg') }}" alt="Background" class="absolute inset-0 w-full h-full object-cover -z-10 filter brightness-75" />
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              ...
              <div class="@container relative min-h-[30rem] w-full grow max-lg:mx-auto max-lg:max-w-sm">
                <div class="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
                  <img class="size-full object-cover object-top" src="{{ asset('images/landings/landing11/urbantree-map.jpg') }}" alt="" />
                </div>
              </div>
            </div>
          ...
          <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              ...
              <div class="@container flex flex-1 items-center max-lg:py-6 lg:pb-2">
                <img class="h-[min(152px,40cqw)] object-cover" src="{{ asset('images/landings/landing7/security.png') }}" alt="">
              </div>
            </div>
  ...
  <div class="absolute inset-0 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
    <img
  src="{{ asset('images/landings/landing4/bg.jpg') }}"
      alt="Naturaleza"
    ...
    <section class="bg-white py-8">
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-wrap items-center justify-center gap-6">
          <img src="{{ asset('images/external-logos/1-gobierno-spain-mefp.png') }}" alt="Sponsor 1" class="h-12" />
          <img src="{{ asset('images/external-logos/2-prtr.png') }}" alt="Sponsor 2" class="h-12" />
          <img src="{{ asset('images/external-logos/3-nextgenerationeu.jpg') }}" alt="Sponsor 3" class="h-12" />
          <img src="{{ asset('images/external-logos/4-insmontsia.jpeg') }}" alt="Sponsor 4" class="h-12" />
          <img src="{{ asset('images/external-logos/5-efalamalvesia.jpg') }}" alt="Sponsor 5" class="h-12" />
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <p class="text-center text-sm mt-8">
      &copy; {{ date("Y") }} {{ config('app.name') }}. {{ __('landings/landing4.tagline') }}
    </p>
  </div>
</footer>
