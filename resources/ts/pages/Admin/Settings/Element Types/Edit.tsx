...
export default function EditElementType() {
    ...
    const validationSchema = Yup.object({
        name: Yup.string().required(t("admin.pages.elementTypes.edit.validations.name_required")),
        requires_tree_type: Yup.boolean().required(t("admin.pages.elementTypes.edit.validations.requires_tree_type")),
        description: Yup.string(),
        icon: Yup.string().required(t("admin.pages.elementTypes.edit.validations.icon_required")),
        color: Yup.string().required(t("admin.pages.elementTypes.edit.validations.color_required")),
    });
                    ...
                    >
                        {({ errors, touched, isSubmitting }) => (
                            <Form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col">
                                    <label className="flex items-center text-sm font-medium text-gray-700 mb-1">
                                        <Icon icon="tabler:file-description" className="h-5 w-5 mr-2" />
