...
const ElementPopup: React.FC<ElementPopupProps> = React.memo(({
  ...
  return (
    <div
      ...
      <h3 className="text-lg font-bold mb-2 border-b pb-2">Elemento #{element.id}</h3>
      <div className="my-2">
        <p className="text-sm mb-1 flex justify-between">
          <strong>Tipo:</strong> <span>{elementType?.name || 'No definido'}</span>
        </p>
        <p className="text-sm mb-1 flex justify-between">
          <strong>Árbol:</strong>{' '}
          <span>
        ...
        <p className="text-sm mb-1 flex justify-between">
          <strong>Creado:</strong> <span>{element.created_at 
